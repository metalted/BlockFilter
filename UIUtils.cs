...
namespace BlockFilter
{
    public static class UIUtils
    {
        ...
        private static readonly Color red = new Color(0.80f, 0.00f, 0.00f, 1.0f);
        private static readonly Color redHover = new Color(1.00f, 0.00f, 0.00f, 1.0f);
        private static readonly Color redActive = new Color(1.00f, 0.30f, 0.30f, 1.0f);
        ...
        {
            RecolorButton(button, red, redHover, redActive, false);
        }
        ...
        public static void StandardRecolorOffButton(LEV_CustomButton button)
        {
